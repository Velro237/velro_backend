...
from .views import (
    ...
    GoogleSignInView, AppleSignInView, IdTypeViewSet,TokenRefreshView, UserLogoutView,ReportUserViewSet
)
...
router.register(r'report-user', ReportUserViewSet, basename='report-user')
