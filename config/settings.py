...
# Only set domain if not in debug mode and domain is provided
SESSION_COOKIE_DOMAIN = os.getenv('SESSION_COOKIE_DOMAIN') if not DEBUG and os.getenv('SESSION_COOKIE_DOMAIN') else None
